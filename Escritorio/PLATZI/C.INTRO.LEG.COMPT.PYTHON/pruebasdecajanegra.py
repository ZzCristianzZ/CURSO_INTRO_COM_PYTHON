...
class CajaNegraTest(unittest.TestCase):
    ...
    # Esto funciona asi:
    #(valor, valorQuerido) = valor == valorQuerido (Nos vuelve un true o  false)
        self.assertEqual(relsutado, 15)
        # Esto funciona asi :
        ...
        # Esto funciona asi:
        # (valor, valorQuerido) = valor <= valorQuerido (Nos devuelve un trueo false)
